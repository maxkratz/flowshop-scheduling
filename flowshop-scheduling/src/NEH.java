...
public class NEH {
   ...
   * 
   */
  public ArrayList<int[]> sortFirstTwoElements(ArrayList<int[]> sortedList, int[] first,
      int[] second) {
  ...
  public ArrayList<int[]> calculateNEHOrder(ArrayList<int[]> jobs) {
    ...
    ArrayList<int[]> myList_2 = this.sortFirstTwoElements(firstTwoElemetList,
        jobs.get(sortierteListe.get(0)[0]), jobs.get(sortierteListe.get(1)[0]));
